...
R_H2_without_space = H(H2_without_space, alphabet)
print('Надлишковість для H2 без пробілів: ', R_H2_without_space)
R_H2_without_space_step_2 = H(H2_without_space_step_2, alphabet)
...
R_H2_with_space = H(H2_with_space, alphabet_p)
print('Надлишковість для H2 з пробілами: ', R_H2_with_space)
R_H2_with_space_step_2 = H(H2_with_space_step_2, alphabet_p)
