...
if __name__ == '__main__':
    ...
    ###########################################
    file = open('TEXT.txt', encoding='utf8')  # зчитуємо текст
    ...
    ###########################################
    file = open('TEXT.txt', encoding='utf8')  # зчитуємо з файлу
...
print('Розрахуємо надлишковіть для виводу программи CoolPinkProgram у випадку значення H10 (10 символів)')
h10 = ((2.25353504037451+2.93707466332325)/2)
rh10 = rozr_nadl(h10, len(alf_a))
print (rh10)

print('Розрахуємо надлишковіть для виводу программи CoolPinkProgram у випадку значення H20 (20 символів)')
h20 = ((1.48883048810586+2.23221634558576)/2)
rh20 = rozr_nadl(h20, len(alf_a))
print (rh20)

print('Розрахуємо надлишковіть для виводу программи CoolPinkProgram у випадку значення H30 (30 символів)')
